-- AUTO-GENERATED by deploy/build.sh -- do not edit directly.
-- Sources: lib/state_sync.lua + src/chuso1800_core.lua + deploy/bridge.lua
-- Paste this whole file into a single Stormworks LUA node.
...
----------------------------------------------------------------------
-- src/chuso1800_core.lua (wrapped as a local module; Stormworks has
-- no require, and a top-level 'return M' mid-file would otherwise be
-- a syntax error once concatenated)
----------------------------------------------------------------------
local core = (function()
