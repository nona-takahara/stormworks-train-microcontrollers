...
--
-- Neither state_sync.lua nor chuso1800_core.lua is a Lua
...
--
-- state_sync.lua is a repo-wide reusable sync driver (not
...
-- chuso1800_core.lua defines core_tick/decode_state/encode_state/
