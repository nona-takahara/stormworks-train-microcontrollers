...
-- would falsely trip the emergency condition on forward/+1 as well as neutral/0),
...
-- `direction_neutral` in current SPEC.md/main.sw-net), i.e. the emergency condition
